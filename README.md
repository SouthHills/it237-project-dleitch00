...
> [!NOTE]
> enter 2 into `id` if you wish to be a regular user who can see only the plant assigned to them, with the username `nonadmin`
...
> [!IMPORTANT]
> Any changes you made will persist even after shutting down. if you wish to reset all changes you made, use `docker compose down -v`
